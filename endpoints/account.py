...
@router.post(
    "/account", response_model=AccountBaseScheme, status_code=status.HTTP_201_CREATED
)
...
@router.delete(
    "/account", status_code=status.HTTP_204_NO_CONTENT, dependencies=[Depends(cookie)]
)
